                        ...
                        <tbody class="bg-white">
                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">{{ $post->created_at->diffForHumans() }}</td>
                                    <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">{{ $post->updated_at->diffForHumans() }}</td>
